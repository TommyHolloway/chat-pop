-- Security Enhancement Migration: Critical Database Security Fixes (Clean)

-- 1. Enhanced Subscriber Table Security
-- Drop all existing service role policies for subscribers
...
-- Add new stricter subscriber table policies
