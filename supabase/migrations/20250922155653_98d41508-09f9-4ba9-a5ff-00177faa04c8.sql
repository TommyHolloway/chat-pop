-- Critical Security Fix: Add RLS policies to security_audit_summary table
-- This table currently has no RLS policies, which is a major security vulnerability

-- Enable RLS on the security_audit_summary table
