-- Add cart_recovery_attempts column to usage_tracking table
ALTER TABLE usage_tracking 
ADD COLUMN IF NOT EXISTS cart_recovery_attempts INTEGER DEFAULT 0;

-- Update check_user_plan_limits function to support new plan structure and cart recovery
  ...
  CASE p_feature_type
    ...
    WHEN 'storage' THEN
      ...
      feature_limit := CASE user_plan
        ...
        WHEN 'growth' THEN 50 * 1024 * 1024 * 1024
