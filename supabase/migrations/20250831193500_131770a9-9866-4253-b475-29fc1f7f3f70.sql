-- Fix critical security issues (excluding auth.config which we can't modify)

-- 1. Fix profiles table RLS policies - remove conflicting policies and create secure ones
...
-- Create single, secure profile policy for authenticated users
...
-- 3. Strengthen leads table security
...
-- 4. Add data retention function for visitor data privacy
